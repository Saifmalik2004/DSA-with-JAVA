public class SubArrays {
    ...
    public static void printSubArray(int num[]) {
        ...
        int minSum = Integer.MAX_VALUE; // Initialize minSum to the largest possible integer value
        ...
        for (int i = 0; i < num.length; i++) {
            ...
            for (int j = i; j < num.length; j++) {
                ...
                // Check if the current subarray sum is smaller than minSum
                if (sum < minSum) {
                    minSum = sum; // Update minSum if the current subarray sum is smaller
                }
        ...
        // Print the minimum sum of all subarrays
    ...
    public static void main(String[] args) {
        int num[] = {1, 2, 3, 4, 5, 8}; // Example array of numbers
